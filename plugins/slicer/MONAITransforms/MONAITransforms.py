...
class MONAITransformsWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        self.ui.fetchVersionInfoButton.setIcon(self.icon("refresh-icon.png"))
        self.ui.fetchVersionInfoButton.connect("clicked(bool)", self.refreshVersion)
    ...
    def is_subclass(self, n, o, class_c):
        if inspect.isclass(o) and n != class_c:
            b = [cls.__name__ for cls in o.__bases__]
            print(f"Base classes => {b}")
            if class_c in b:
                print(f"Subclass for {class_c} Found: {o}")
                return True
        return False

    def get_class_of_subclass(self, module, class_c):
        print(f"{module} => {class_c}")
        res = set()
        for n, o in inspect.getmembers(module):
            ...
            print(f"{n} => {o}")
            if self.is_subclass(n, o, class_c):
                res.add(f"{o.__module__}.{o.__name__}")
    ...
    def refreshTransforms(self):
        ...
        import monai.transforms.post.dictionary as mt
        names = self.get_class_of_subclass(mt, "Transform")
        print(json.dumps(names, indent=2))
        self.ui.transformsComboBox.addItems(names)


#
# MONAITransformsLogic
#
...
class MONAITransformsTest(ScriptedLoadableModuleTest):
    ...
    def test_MONAITransforms1(self):
        ...
        import SampleData
        registerSampleData()
        inputVolume = SampleData.downloadSample('MONAITransforms1')
